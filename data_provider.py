...
def load_train_info():
    ...
    #train_info = read_lines('C:\\Users\\585000\\PycharmProjects\\AG_t1\\data\\train_info_s.csv')[1:]
    parsed_train_info = {}
...
def load_organized_data_info(imgs_dim_1d, multi_crop=False):
    print(_organized_data_info_file_dim(imgs_dim_1d, multi_crop))
    if not isfile(_organized_data_info_file_dim(imgs_dim_1d, multi_crop)):

    #if not isfile('C:\\Users\\585000\\PycharmProjects\\AG_t1\\data\\organized_data_info_256.json'):#_organized_data_info_file_dim(imgs_dim_1d, multi_crop)):
